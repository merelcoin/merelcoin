# Support for Output Descriptors in MerelCoin Core

Since MerelCoin Core v0.17, there is support for Output Descriptors in the
...
on MerelCoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing MerelCoin Core wallets, a convenience function `combo` is
