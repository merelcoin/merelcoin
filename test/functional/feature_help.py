...
"""Verify that starting merelcoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start merelcoin with -h for help text")
        ...
        self.log.info("Start merelcoin with -version for version information")
        ...
        self.log.info("Start merelcoind with -fakearg to make sure it does not start")
