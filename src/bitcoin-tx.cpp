...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " merelcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  merelcoin-tx [options] <hex-tx> [commands]  Update hex-encoded merelcoin transaction\n" +
            "or:     merelcoin-tx [options] -create [commands]   Create hex-encoded merelcoin transaction\n" +
            "\n";
